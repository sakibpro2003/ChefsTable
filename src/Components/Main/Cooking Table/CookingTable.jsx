...
const CookingTable = ({cookingTable, currentlyCooking, handlePrepareRecipe, handleCookingTime, handleFoodCalories}) => {
    ...
    return (
        <div className="lg:w-1/3">
            <div className="border-2 border-black-100 p-[32px] w-[460px] lg:w-[520px] m-auto rounded-xl mb-[50px]">
                ...
                <hr className="mb-[24px]"/>
                {
                    currentlyCooking.map(currentlyCookingRecipe => <WantToCook key={currentlyCookingRecipe.id} wantToCook={currentlyCookingRecipe} handlePrepareRecipe={handlePrepareRecipe} />)
                }
                <hr className="mb-[24px]"/>
                <div className="flex">
...
CookingTable.propTypes = {
    ...
    handlePrepareRecipe: PropTypes.func.isRequired,
